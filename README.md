A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: External Contact Query
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-external-contact-query-data-action-module.git?ref=v1.0.0"
    action_name        = "External Contact Query"
